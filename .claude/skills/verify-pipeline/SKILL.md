...
Then run the post-run probes P4–P12 from [probes.md](references/probes.md): false gaps,
anti-cheat greps over the final diff, reviewer recall, catalog metadata delta,
browser-session leakage, alias closure, and cleanup durability.
