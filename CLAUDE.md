...
Both of those skills are **vendor-managed** — generated by the Playwright tools, not written here.
Do not hand-edit them. Regenerate after a Playwright upgrade:

| Skill              | Refresh with                        | Source                              |
| ------------------ | ----------------------------------- | ----------------------------------- |
...
The refresh has one known casualty: `playwright-cli/references/test-generation.md` is edited locally
to say `specs/product/<feature>.plan.md` (the vendor ships `specs/`), and the refresh silently
reverts all four occurrences. Re-apply them, then
`grep -n "specs/" .claude/skills/playwright-cli/references/test-generation.md` to confirm.
